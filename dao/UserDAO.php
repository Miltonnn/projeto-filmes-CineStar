<?php 
  ...
  class UserDAO implements UserDAOInterface {
    ...
    public function buildUser($data) {
      ...
      // Verifique se o índice 'name' existe antes de acessá-lo
      if (isset($data["name"])) {
        $user->name = $data["name"];
      } else {
        // Lidar com o caso em que 'name' não está definido, por exemplo, definir um valor padrão ou lançar uma exceção.
         $user->name = "Milton";
      }
